...
func main() {
	...
	authorizationPolicy := flag.String("authorization-policy", "", "optional absolute UID authorization policy")
	capabilityKeyring := flag.String("capability-keyring", "", "optional trusted keyring for one-time capabilities")
